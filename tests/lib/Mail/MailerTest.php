...
class MailerTest extends TestCase {
	...
	public function testGetSendmailInstanceSendMail($sendmailMode, $binaryParam) {
		...
		$expected = new SendmailTransport($path . $binaryParam);
	...
	public function testGetSendmailInstanceSendMailQmail($sendmailMode, $binaryParam) {
		...
		$this->assertEquals(new SendmailTransport('/var/qmail/bin/sendmail' . $binaryParam), self::invokePrivate($this->mailer, 'getSendMailInstance'));
	}
